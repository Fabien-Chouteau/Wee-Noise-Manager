...
private with GUI.Signal_Path;
private with GUI.Track_Engine_Select;
private with GUI.Track_Sub_Select;

package GUI.Track_Config is
...
private
   ...
   type Widget_Record is new Parent_Record and Updatable_Record with record
      ...
      Sub    : GUI.Track_Sub_Select.Widget;
      Signal : GUI.Signal_Path.Widget;
   end record;
